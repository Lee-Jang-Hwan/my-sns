...
- [x] `/profile/[userId]` 동적 라우트
- [x] 프로필 헤더 컴포넌트
  - [x] 아바타 (150px Desktop / 90px Mobile)
  - [x] 사용자명, 이름
  - [x] 통계 (게시물, 팔로워, 팔로잉)
  - [x] 팔로우/팔로잉 버튼
  - [x] 내 프로필인 경우 "프로필 편집" 버튼 (1차 제외)
- [x] `/api/users/[userId]` GET API
- [x] 사용자 통계 조회 (user_stats 뷰 활용)
...
- [x] 모바일 반응형 테스트 (< 768px)
- [x] 태블릿 반응형 테스트 (768px ~ 1024px)
- [x] 데스크톱 반응형 테스트 (1024px+)
